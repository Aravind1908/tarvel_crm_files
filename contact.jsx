  ...
  return (
    <div className="container-fluid vh-100 d-flex justify-content-center align-items-center bg-light">
      <div className="row shadow rounded overflow-hidden w-75">
        {/* Left Panel */}
        <div className="col-md-5 p-4 text-white"
             style={{background: "linear-gradient(180deg, #6a11cb 0%, #2575fc 100%)"}}>
          ...
          <div className="bg-white bg-opacity-10 rounded p-3 mb-4">
            <p className="mb-1">1500+ <small>Verified Agents</small></p>
            <p className="mb-1">100k+ <small>Happy Travellers</small></p>
            <p className="mb-0">190+ <small>Destinations</small></p>
          </div>
        ...
        <div className="col-md-7 bg-white p-4">
          ...
          <p className="text-muted mb-4">Tell us about your dream destination</p>
          ...
          <form>
            ...
            <div className="d-flex gap-2 mb-3">
              <button type="button" className="btn btn-danger w-50">Fixed</button>
              <button type="button" className="btn btn-outline-secondary w-50">Flexible</button>
            </div>
            ...
            <div className="row g-2 mb-3">
              <div className="col">
                <select className="form-select">
                  ...
                  {[...Array(10)].map((_, i) => <option key={i}>{i}</option>)}
                </select>
              </div>
              <div className="col">
                <select className="form-select">
